<script lang="ts">
	...
	function getTeamLogoColors(
		lobbyId: string,
		lobbyName: string
	): { bgColor: string; circleColor: string; letter: string } {
...
<section class="lobby-page" style="background-image: url({homepageBackground});">
	...
	<div class="content-wrapper mx-auto p-8">
...
<style>
	...
	.lily-pad {
		...
		height: 120px;
		border-radius: 50%;
		background: radial-gradient(circle at 30% 30%, rgba(0, 180, 0, 0.7), rgba(0, 140, 0, 0.4));
	...
	@keyframes jumpAround {
		...
		20% {
			transform: translate(100px, -20px) rotate(20deg) scale(1);
		}
		30% {
			transform: translate(150px, -60px) rotate(5deg) scale(0.95);
		}
		40% {
			transform: translate(200px, 0) rotate(0deg) scale(1);
		}
		50% {
			transform: translate(150px, -40px) rotate(-10deg) scale(1.05);
		}
		60% {
			transform: translate(100px, 30px) rotate(-20deg) scale(1);
		}
		70% {
			transform: translate(50px, -20px) rotate(-5deg) scale(0.95);
		}
		80% {
			transform: translate(30px, 20px) rotate(10deg) scale(1);
		}
		90% {
			transform: translate(10px, -30px) rotate(15deg) scale(1.02);
		}
		100% {
			transform: translate(0, 0) rotate(0deg) scale(1);
		}
