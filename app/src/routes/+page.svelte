...
<section>
	<h1>
		...
		{#if username}
			...
			<button on:click={logoutUser} class="rounded bg-indigo-600 px-6 py-3 font-bold text-white hover:bg-indigo-700" style="cursor: pointer;">
		Logout
	</button>
		{:else}
			<p class="text-center text-lg text-gray-500 mt-4">User not Logged in!</p>
		{/if}
