...
export type EventsGamesResponse<Tdata = unknown, Texpand = unknown> = Required<
	EventsGamesRecord<Tdata>
> &
	BaseSystemFields<Texpand>;
export type LobbiesResponse<Texpand = unknown> = Required<LobbiesRecord> &
	BaseSystemFields<Texpand>;
export type PlayerPositionsResponse<Texpand = unknown> = Required<PlayerPositionsRecord> &
	BaseSystemFields<Texpand>;
export type PositionsResponse<Texpand = unknown> = Required<PositionsRecord> &
	BaseSystemFields<Texpand>;
